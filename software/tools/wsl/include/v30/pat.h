...
/* match.c */
BYTES amatch(TEXT *buf, FAST BYTES n, BYTES indx, TEXT *pat, MSUB *pmsub);
BOOL match(TEXT *buf, FAST BYTES n, FAST TEXT *pat);
/* pat.c */
TEXT *pattern(FAST TEXT *pat, TEXT delim, TEXT *p);
